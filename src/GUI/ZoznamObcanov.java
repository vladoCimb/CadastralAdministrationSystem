 ...
 * @author Vladko
 */
public class ZoznamObcanov extends javax.swing.JPanel {
    ...
    public ZoznamObcanov(JFrame frame, MainSystem system) {
        this.system = system;
        mainWindow = frame;
        initComponents();
        inicializacia();
    ...
    public void showList() {
        jTable1.setModel(new TableModels.ZoznamObcanovTabModel(system.getCitiziens()));
        ZoznamObcanovTabModel model = new ZoznamObcanovTabModel(system.getCitiziens());
        sorter = new TableRowSorter<ZoznamObcanovTabModel>(model);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Zoznam občanov");
    ...
    private void newBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newBTActionPerformed
        Globals.panel.addTab("Občan", new Obcan(mainWindow, system, 0));
        logika.setLastTab();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            String firstName = jTable1.getValueAt(selectedRowIndex, 0).toString();
            String surName = jTable1.getValueAt(selectedRowIndex, 1).toString();
            String identifNum = jTable1.getValueAt(selectedRowIndex, 2).toString();
            String permResidence = jTable1.getValueAt(selectedRowIndex, 3).toString();
    ...
    private void changeBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeBTActionPerformed
        ...
        if (selectedRowIndex >= 0) {
            ...
            Person person = new Person(firstName, surName, Integer.parseInt(identifNum), system.findPropertyByRegNumb(Integer.parseInt(permResidence)));
            Obcan panel = new Obcan(mainWindow, system, person);
            Globals.panel.addTab("Občan " + surName, panel);
            logika.setLastTab();
        } else {
            JOptionPane.showMessageDialog(mainWindow, "Zvoľte občana, ktorého chcete upraviť");
        }
